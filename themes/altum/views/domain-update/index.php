...
<div class="container">
    ...
    <form action="" method="post" role="form">
        ...
        <div class="form-group">
            ...
            <input type="text" id="custom_index_url" name="custom_index_url" class="form-control" value="<?= $data->domain->custom_index_url ?>" placeholder="<?= l('domains.input.custom_index_url_placeholder') ?>" />
        ...
        <div class="form-group">
            ...
            <input type="text" id="custom_not_found_url" name="custom_not_found_url" class="form-control" value="<?= $data->domain->custom_not_found_url ?>" placeholder="<?= l('domains.input.custom_not_found_url_placeholder') ?>" />
