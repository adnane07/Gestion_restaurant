...
<div class="row mb-4">
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            <div class="card-body">
                <h3 class="h5"><?= l('statistics.statistics.country') ?></h3>
                <p></p>
            ...
            <div class="px-4 py-2">
                <a href="<?= url('statistics?' . $data->identifier_key . '=' . $data->identifier_value . '&type=country&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted"><i class="fa fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('statistics.statistics.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="px-4 py-2">
                <a href="<?= url('statistics?' . $data->identifier_key . '=' . $data->identifier_value . '&type=referrer_host&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted"><i class="fa fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('statistics.statistics.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="px-4 py-2">
                <a href="<?= url('statistics?' . $data->identifier_key . '=' . $data->identifier_value . '&type=device&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted"><i class="fa fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('statistics.statistics.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="px-4 py-2">
                <a href="<?= url('statistics?' . $data->identifier_key . '=' . $data->identifier_value . '&type=os&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted"><i class="fa fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('statistics.statistics.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="px-4 py-2">
                <a href="<?= url('statistics?' . $data->identifier_key . '=' . $data->identifier_value . '&type=browser&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted"><i class="fa fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('statistics.statistics.view_more') ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 my-3">
        <div class="card h-100">
            ...
            <div class="px-4 py-2">
                <a href="<?= url('statistics?' . $data->identifier_key . '=' . $data->identifier_value . '&type=language&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted"><i class="fa fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('statistics.statistics.view_more') ?></a>
            </div>
        </div>
    </div>
</div>
...
<div>
    <div class="d-flex align-items-center mb-3">
        <h2 class="small font-weight-bold text-uppercase text-muted mb-0 mr-3"><i class="fa fa-fw fa-sm fa-chart-bar mr-1"></i> <?= l('statistics.statistics.latest') ?></h2>
    ...
    <div class="table-responsive table-custom-container">
        <table class="table table-custom">
            <thead>
            <tr>
                <th><?= l('statistics.table.country') ?></th>
                <th><?= l('statistics.table.city') ?></th>
                <th><?= l('statistics.table.device') ?></th>
                <th><?= l('statistics.table.os') ?></th>
                <th><?= l('statistics.table.browser') ?></th>
                <th><?= l('statistics.table.referrer') ?></th>
            ...
            <tr>
                <td colspan="7">
                    <a href="<?= url('statistics?' . $data->identifier_key . '=' . $data->identifier_value . '&type=entries&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" class="text-muted">
                        <i class="fa fa-angle-right fa-sm fa-fw mr-1"></i> <?= l('statistics.statistics.view_more') ?>
                    </a>
                </td>
            </tr>
