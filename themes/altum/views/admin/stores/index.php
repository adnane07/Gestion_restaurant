...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3 m-0"><i class="fa fa-fw fa-xs fa-store text-primary-900 mr-2"></i> <?= l('admin_stores.header') ?></h1>
    ...
    <div class="table-responsive table-custom-container">
        <table class="table table-custom">
            ...
            <tr>
                ...
                <th><?= l('admin_stores.table.user') ?></th>
                <th><?= l('admin_stores.table.name') ?></th>
                <th><?= l('admin_stores.table.stats') ?></th>
                <th><?= l('admin_stores.table.is_enabled') ?></th>
            ...
            <?php foreach($data->stores as $row): ?>
                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        <?= $row->name ?><a href="<?= url('store-redirect?store_id=' . $row->store_id) ?>" rel="noreferrer"><i class="fa fa-fw fa-xs fa-external-link-alt ml-1"></i></a>
                    </td>
                    <td class="text-nowrap">
                        <div class="d-flex flex-column">
