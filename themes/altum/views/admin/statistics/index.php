        ...
        <div class="card">
            <div class="card-body">
                <div class="nav flex-column nav-pills">
                    ...
                    <?php endif ?>
                    <a class="nav-link <?= $data->type == 'stores' ? 'active' : null ?>" href="<?= url('admin/statistics/stores?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-store mr-1"></i> <?= l('admin_statistics.stores.menu') ?></a>
