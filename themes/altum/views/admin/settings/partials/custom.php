...
<div>
    ...
    <div class="form-group">
        ...
        <textarea id="head_js_store" name="head_js_store" class="form-control form-control-lg"><?= settings()->custom->head_js_store ?></textarea>
    </div>

    <div class="form-group">
        <label for="head_css_store"><i class="fab fa-fw fa-sm fa-css3 text-muted mr-1"></i> <?= l('admin_settings.custom.head_css_store') ?></label>
        <textarea id="head_css_store" name="head_css_store" class="form-control form-control-lg"><?= settings()->custom->head_css_store ?></textarea>
    </div>
</div>
