...
class OrdersDaily extends Controller {
    ...
    public function index() {
        ...
        $paginator = (new \Altum\Paginator($total_rows, 25, $_GET['page'] ?? 1, url('orders-daily/' . $store->store_id . '?page=%d')));
        ...
        /* Set a custom title */
        Title::set(sprintf(l('orders.header.today'), $pending_orders));
        ...
        $view = new \Altum\View('orders-daily/index', (array) $this);
    ...
    public function complete() {
        ...
        if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
            ...
            redirect('orders-daily/' . $order->store_id);
